...
# 1800 "/Applications/microchip/xc8/v2.31/pic/include/pic_as_chip_select.inc" 3
# 1 "/Applications/microchip/xc8/v2.31/pic/include/proc/pic16f1789.inc" 1 3
# 48 "/Applications/microchip/xc8/v2.31/pic/include/proc/pic16f1789.inc" 3
INDF0 equ 0000h
...
# 11829 "/Applications/microchip/xc8/v2.31/pic/include/proc/pic16f1789.inc" 3
...
# 1801 "/Applications/microchip/xc8/v2.31/pic/include/pic_as_chip_select.inc" 2 3
...
initialisation:
    ...
    movwf TRISE ;((PORTE) and 07Fh), 0, ((PORTE) and 07Fh), 1, ((PORTE) and 07Fh), 2, and ((PORTE) and 07Fh), 3 are inputs

    movlw 01111111B ;Set the port pin types of the ((EECON1) and 07Fh), 0
    movwf TRISD ;((PORTD) and 07Fh), 7 is output
...
main_loop:
    movlb 00h
    btfss PORTE, 0 ;Read ((PORTE) and 07Fh), 0 pin
    goto button_is_off ;If ((PORTE) and 07Fh), 0 is '0', then go to button_is_off
    goto button_is_on ;Else go to button_is_on
    ;movlb 00h
    ;btfss PORTE, 1 ;Read ((PORTE) and 07Fh), 1 pin
    ;goto button_is_off ;If ((PORTE) and 07Fh), 1 is '0', then go to button_is_off
    ;goto button_is_on ;Else go to button_is_on
    ;movlb 00h
    ;btfss PORTE, 2 ;Read ((PORTE) and 07Fh), 2 pin
    ;goto button_is_off ;If ((PORTE) and 07Fh), 2 is '0', then go to button_is_off
    ;goto button_is_on ;Else go to button_is_on
    ;movlb 00h
    ;btfss PORTE, 3 ;Read ((PORTE) and 07Fh), 3 pin
    ;goto button_is_off ;If ((PORTE) and 07Fh), 3 is '0', then go to button_is_off
    ;goto button_is_on ;Else go to button_is_ons
    ;goto main_loop

button_is_on:
    movlb 02h
    movlw 10000000B ;Set ((PORTD) and 07Fh), 7 output
    movwf LATD
    goto main_loop ;Go back to the main loop

button_is_off:
    movlb 02h
    movlw 00000000B ;Clear ((PORTD) and 07Fh), 7 output
    movwf LATD
    goto main_loop ;Go back to the main loop
